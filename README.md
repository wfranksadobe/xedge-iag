...
## Environments
- Preview: https://main--xedge-iag--wfranksadobe.aem.page/
- Live: https://main--xedge-iag--wfranksadobe.aem.live/
...
1. Open the `xedge-iag` directory in your favorite IDE and start coding :)